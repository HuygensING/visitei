 ...
 */
class IgnoreProcessingInstructionHandler<T : Context> : ProcessingInstructionHandler<T> {
    override fun visitProcessingInstruction(processingInstruction: ProcessingInstruction, context: T): Traversal {
